...
public abstract class AbstractOsgiTests extends AbstractOptionalDependencyInjectionTests {
     ...
     */
    private TestCase osgiJUnitTest = null;
     ...
     * 
     * <p/>
     * Normally, this method is called only once during the lifecycle of a test
     * suite.
     * 
     * @param platformBundleContext
     *            the platform bundle context
     * @throws Exception
     *             if processing the bundle context fails
     ...
     * 
     * <p/>
     * Replacement run method. Gets a hold of the TestRunner used for running
    ...
    private AtomicInteger disabledCount = new AtomicInteger(0);

    private String getDisabledTestCount() {
        return disabledCount.toString();
    }
    ...
    private boolean isDisabledInThisEnvironment(String name) {
        return false;
    }
     ...
     * 
     * <p/>
     * This method is called automatically by the test infrastructure after the
     * OSGi platform is being setup.
     */
