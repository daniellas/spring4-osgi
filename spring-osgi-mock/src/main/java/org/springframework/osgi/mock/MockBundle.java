...
public class MockBundle implements Bundle {
    ...
    /**
     * Constructs a new <code>MockBundle</code> instance with the given symbolic
     * name.
     * 
     * @param symName
    ...
    /**
     * Constructs a new <code>MockBundle</code> instance using the given bundle
     * symbolic name, properties and associated bundle context.
     * 
     * @param symName
     *            bundle symbolic name
     * @param headers
